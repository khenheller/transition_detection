...
def transition_detection(listing_acc_path:str,listing_gait_path:str ,listing_lying_path:str):
    ...
    for ff in range(len(listing_lumbar)): #for each subject
        ...
        locs=clean_pt(locs, ix_stillnes, d3['fs'], s_start_pt, s_end_pt)
        ...
        pt=delete_PT_next_to_lying(pt, lying_vec_lumbar, ix_stillnes, walking_vec_lumbar, fs)
        ...
        sitting_vec=delete_still_periods(s2sit_index, walking_vec_lumbar, s2stand_index, ix_stillnes, lying_vec_lumbar, fs)
